...
const Project = () => {
    ...
    const project_items = [
        ...
        { title: "THE FULL EXPLANATION", subtitle: "(self-employed)", desc: "Developed The Full Explanation, an interface using HTML, CSS, JS and Flask, that acts as an wrapper around API calls to Mistral-7B-Instruct, hosted on HuggingFace, which provides explanations for a user’s topics and generates further explanations for complicated terms in any generated explanations recursively. ", link: "Deployed link: personal-wiki-srgi.onrender.com", linkref: "https://personal-wiki-srgi.onrender.com/", svgName: FullExplanation, id: 2},
