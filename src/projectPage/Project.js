...
function ProjectItem({ item }) {
    ...
    const Illustration = illustrations[item.image];
    ...
    return (
        ...
        <div className="project-item">
            ...
            {Illustration && (
                <Illustration className="project-image" />
            )}
...
useEffect(() => {
    ...
    async function loadProjects() {
        ...
        const slugs = await fetch("/content/projects/index.json")
            .then(res => res.json());
